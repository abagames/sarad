/* original version: https://github.com/karpathy/recurrentjs
 changed by @abagames
 - module.exports = R
 - comment out the unused code
 - move some var declarations outside the scope
 - new RandMat -> RandMat
*/
...
(function(global) {
  ...
  var zeros = function(n) {
    ...
    if(typeof(n)==='undefined' || isNaN(n)) { return new Float64Array(0); }
  ...
  var initRNN = function(input_size, hidden_sizes, output_size) {
    ...
    for(var d=0;d<hidden_sizes.length;d++) { // loop over depths
      var prev_size = d === 0 ? input_size : hidden_sizes[d - 1];
      var hidden_size = hidden_sizes[d];
      model['Wxh'+d] = RandMat(hidden_size, prev_size , 0, 0.08);
      model['Whh'+d] = RandMat(hidden_size, hidden_size, 0, 0.08);
